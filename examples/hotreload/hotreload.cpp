// examples/hotreload/hotreload.cpp
#include <cui/app.h>
...
int main(int argc, char* argv[]) {
    ...
    app.set_render_callback([&]() {
        ...
        renderer.draw_text("CUIFramework - Hot Reload Demo", 50, 30, 28, cui::Colors::White);
        renderer.draw_text("Edit guest/src/ui_main.cpp and save to see live updates!", 50, 70, 16, cui::Colors::LightGray);
        renderer.draw_text("Hot Reload: Active", 50, 140, 16, cui::Colors::Green);
